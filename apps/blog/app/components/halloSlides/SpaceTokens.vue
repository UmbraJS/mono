...
const spaceTokens = [
  { name: '--space-1', value: '10px' },
  { name: '--space-2', value: 'calc(10px * 2)' },
  { name: '--space-3', value: 'calc(10px * 4)' },
  { name: '--space-4', value: 'calc(10px * 8)' },
  { name: '--space-5', value: 'calc(10px * 16)' },
  { name: '--space-6', value: 'calc(10px * 32)' }
];
