import * as better_auth_client4 from "better-auth/client";
import * as vue1 from "vue";
import * as vue457 from "vue";
import * as vue459 from "vue";
import { MaybeRefOrGetter, Ref } from "vue";
import * as convex_server456 from "convex/server";
import * as convex_server461 from "convex/server";
...
import * as better_auth_adapters469 from "better-auth/adapters";
import * as node_modules_better_auth_dist_shared_better_auth_DNnBkMGu18 from "node_modules/better-auth/dist/shared/better-auth.DNnBkMGu";
 ...
 * ```
 */
declare function createUseAuth<TSession extends BetterAuthSession = BetterAuthSession>(nuxtComposables: {
  useRequestURL: () => URL;
  ...
  session: Ref<TSession | null, TSession | null>;
  user: vue1.ComputedRef<TSession["user"] | null>;
  isAuthenticated: vue1.ComputedRef<boolean>;
  isLoading: vue1.ComputedRef<boolean>;
  client: {
    signIn: {
      social: <FetchOptions extends {
        ...
        onRequest?: (<T extends Record<string, any>>(context: better_auth_client4.RequestContext<T>) => Promise<better_auth_client4.RequestContext | void> | better_auth_client4.RequestContext | void) | undefined;
        onResponse?: ((context: better_auth_client4.ResponseContext) => Promise<Response | void | better_auth_client4.ResponseContext> | Response | better_auth_client4.ResponseContext | void) | undefined;
        onSuccess?: ((context: better_auth_client4.SuccessContext<any>) => Promise<void> | void) | undefined;
        onError?: ((context: better_auth_client4.ErrorContext) => Promise<void> | void) | undefined;
        onRetry?: ((response: better_auth_client4.ResponseContext) => Promise<void> | void) | undefined;
        hookOptions?: {
          cloneResponse?: boolean;
        } | undefined;
        timeout?: number | undefined;
        customFetchImpl?: better_auth_client4.FetchEsque | undefined;
        plugins?: better_auth_client4.BetterFetchPlugin[] | undefined;
        ...
        retry?: better_auth_client4.RetryOptions | undefined;
        retryAttempt?: number | undefined;
        output?: (better_auth_client4.StandardSchemaV1 | typeof Blob | typeof File) | undefined;
        errorSchema?: better_auth_client4.StandardSchemaV1 | undefined;
        disableValidation?: boolean | undefined;
      }>(data_0: node_modules_better_auth_dist_shared_better_auth_DNnBkMGu18.a<{
        provider: unknown;
        callbackURL?: string | undefined;
        newUserCallbackURL?: string | undefined;
        errorCallbackURL?: string | undefined;
      ...
      }>, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<NonNullable<{
        redirect: boolean;
        token: string;
        url: undefined;
        user: {
    ...
    signOut: <FetchOptions extends {
      ...
      fetchOptions?: FetchOptions | undefined;
    }> | undefined, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<{
      success: boolean;
    }, {
      code?: string;
      message?: string;
    ...
    signIn: {
      email: <FetchOptions extends {
        ...
        fetchOptions?: FetchOptions | undefined;
      }>, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<{
        redirect: boolean;
        token: string;
    ...
    verifyEmail: <FetchOptions extends {
      ...
      fetchOptions?: FetchOptions | undefined;
    }>, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<NonNullable<void | {
      status: boolean;
      user: {
        id: string;
        email: string;
    ...
    updateUser: <FetchOptions extends {
      ...
      name?: string;
      fetchOptions?: FetchOptions | undefined;
    } & Partial<{}>> | undefined, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<{
      status: boolean;
    }, {
      code?: string;
      message?: string;
    ...
    resetPassword: {
      ":token": <FetchOptions extends {
        ...
        fetchOptions?: FetchOptions | undefined;
      }>, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<never, {
        code?: string;
        message?: string;
      }, FetchOptions["throw"] extends true ? true : false>>;
    };
    ...
    listSessions: <FetchOptions extends {
      ...
      query?: Record<string, any> | undefined;
      fetchOptions?: FetchOptions | undefined;
    }> | undefined, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<node_modules_better_auth_dist_shared_better_auth_DNnBkMGu18.a<{
      id: string;
      createdAt: Date;
      updatedAt: Date;
      userId: string;
    ...
    refreshToken: <FetchOptions extends {
      ...
      fetchOptions?: FetchOptions | undefined;
    }>, data_1?: FetchOptions | undefined) => Promise<better_auth_client4.BetterFetchResponse<any, {
      code?: string;
      message?: string;
    }, FetchOptions["throw"] extends true ? true : false>>;
  } & {
    ...
    useSession: better_auth_client4.Atom<{
      data: {
        user: {
          id: string;
          createdAt: Date;
      ...
      error: better_auth_client4.BetterFetchError | null;
      isPending: boolean;
    }>;
    $fetch: better_auth_client4.BetterFetch<{
      plugins: (better_auth_client4.BetterFetchPlugin | {
        id: string;
        name: string;
        hooks: {
          onSuccess: ((context: better_auth_client4.SuccessContext<any>) => Promise<void> | void) | undefined;
        ...
        name: string;
        hooks: {
          onSuccess(context: better_auth_client4.SuccessContext<any>): void;
        };
      })[];
      cache?: RequestCache | undefined;
      ...
      timeout?: number | undefined;
      customFetchImpl: better_auth_client4.FetchEsque;
      baseURL: string;
      throw?: boolean | undefined;
      auth?: ({
        type: "Bearer";
    ...
    $store: {
      ...
      atoms: Record<string, better_auth_client4.WritableAtom<any>>;
    };
    $Infer: {
      Session: {
        user: {
  ...
  fetchSession: () => Promise<TSession | null>;
}; //#endregion
...
declare function useConvexMutation<Mutation extends FunctionReference<'mutation'>>(mutationReference: Mutation, {
  ...
  mutate: (args: MaybeRefOrGetter<FunctionArgs<Mutation>>) => Promise<convex_server456.FunctionReturnType<Mutation>>;
  error: vue457.Ref<Error | null, Error | null>;
  isPending: vue457.ComputedRef<boolean>;
};
...
declare function createConvexClients(url: string, clientOptions?: ConvexClientOptions): {
  clientRef: vue459.ShallowRef<ConvexClient | undefined, ConvexClient | undefined>;
  httpClientRef: vue459.ShallowRef<ConvexHttpClient | undefined, ConvexHttpClient | undefined>;
  initClient: (options?: ConvexVueOptions) => void;
};
...
declare function convex(): {
  id: string;
  endpoints: {
    convexToken: (ctx: any) => Promise<any>;
  };
  init(_ctx: any): {
    options: {
      advanced: {
...
declare function createApi<DataModel extends GenericDataModel, Schema extends SchemaDefinition<any, any>>(_schema: Schema, _createAuth: CreateAuth<DataModel>): {
   ...
   */
  create: convex_server461.RegisteredMutation<"public", any, Promise<any>>;
  /**
   * Find a single document
   */
  findOne: convex_server461.RegisteredQuery<"public", any, Promise<any>>;
  /**
   * Find multiple documents
   */
  findMany: convex_server461.RegisteredQuery<"public", any, Promise<any>>;
  /**
   * Update a single document
   */
  updateOne: convex_server461.RegisteredMutation<"public", any, Promise<any>>;
  /**
   * Update multiple documents
   */
  updateMany: convex_server461.RegisteredMutation<"public", any, Promise<any>>;
  /**
   * Delete a single document
   */
  deleteOne: convex_server461.RegisteredMutation<"public", any, Promise<void>>;
  /**
   * Delete multiple documents
   */
  deleteMany: convex_server461.RegisteredMutation<"public", any, Promise<any>>;
  /**
   * Migration helper to remove userId field
   */
  migrationRemoveUserId: convex_server461.RegisteredMutation<"public", any, Promise<void>>;
};
...
declare function createClient<DataModel extends GenericDataModel, _Schema = any>(component: ComponentReference, config?: ClientConfig): {
   ...
   */
  adapter(ctx: GenericCtx<DataModel>): better_auth_adapters469.AdapterFactory;
  /**
...
declare function isConvueDebugEnabled(): boolean;
declare function setConvueDebug(enabled: boolean): void;
declare function debugLog(...args: unknown[]): void;

//#endregion
export { AreAllPropertiesOptional, BetterAuthClient, BetterAuthSessionResult, ClientConfig, ComponentReference, ConvexAuthOptions, ConvexVueContext, ConvexVueOptions, CreateAuth, GenericCtx, IsOptionalKey, OptionalRestArgs, OptionalRestArgsAndOptions, Session, convex, convexClient, createApi, createClient, createConvexClients, createUseAuth, debugLog, getStaticAuth, isConvueDebugEnabled, setConvueDebug, useConvexClient, useConvexHttpClient, useConvexHttpQuery, useConvexMutation, useConvexQuery };